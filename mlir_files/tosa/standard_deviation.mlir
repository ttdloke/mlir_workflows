module attributes {torch.debug_module_name = "Model"} {
  func.func @forward(%arg0: tensor<256x128x4x8x1x16xf32>) -> tensor<128x4x1xf32> {
    ...
    %16 = tosa.pow %15, %2 : (tensor<128x4x1xf32>, tensor<1x1x1xf32>) -> tensor<128x4x1xf32>
    return %16 : tensor<128x4x1xf32>
  }
}
